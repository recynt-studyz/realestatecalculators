  ...
  return (
    <footer className="border-t border-gray-100 dark:border-gray-800 py-6 mt-8">
      <p className="text-center text-xs text-gray-400 mb-3 px-4">
        Free real estate calculators for mortgage payments, home affordability, rent vs buy, closing costs, investment ROI, fix and flip, cap rate, cash on cash return, mortgage payoff and property tax. All 50 states. 2026 data.
      </p>
      <div className="max-w-3xl mx-auto px-4 flex flex-wrap items-center justify-center gap-x-4 gap-y-1 text-xs text-gray-400">
        <span className="font-mono">realestatecalculators.app</span>
        <span>·</span>
